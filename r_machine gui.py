...
def can():
    ...
    def cal():
        ...
        val = round(val, 2)
        p = str(val)
        lbl_total.config(text=("Rs. " + p))
        cal11 = str(cal)
        lbl2.config(text="Rs. " + cal11)
    ...
    lbl1 = Label(can, text="Amount added  ", bg="white", fg="black", font=("verdana", 16))
    lbl1.place(x=70, y=170)

    lbl2 = Label(can, text='Rs. 0.0', bg="white", fg="black", font=("verdana", 16))
    lbl2.place(x=235, y=170)
...
def bottle():
    ...
    lbl1 = Label(bottle, text="Amount added      ", bg="white", fg="black", font=("verdana", 16))
    lbl1.place(x=70, y=170)

    lbl2 = Label(bottle, text='Rs. 0.0', bg="white", fg="black", font=("verdana", 16))
    lbl2.place(x=235, y=170)
...
def paper():
    ...
    lbl1 = Label(paper, text="Amount added ", bg="white", fg="black", font=("verdana", 16))
    lbl1.place(x=70, y=170)

    lbl2 = Label(paper, text='Rs. 0.0 ', bg="white", fg="black", font=("verdana", 16))
    lbl2.place(x=235, y=170)
...
lbl_total = Label(lb2, text=" Rs. 0.0 ", bg="#82e0aa", font=("verdana", 18))
lbl_total.pack(expand=True, fill="both")
